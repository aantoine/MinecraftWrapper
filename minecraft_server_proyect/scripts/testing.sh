...
#Settings
SERVICE='minecraft_testing'
JAR='minecraft_server.1.8.4.jar'
SERVICEPATH='../../jars/minecraft_server.1.8.4.jar'
OPTIONS='nogui'
WORLD='world'
SCREENNAME='minecraft_testing'
MCPATH='/var/www/html/MinecraftWrapper/minecraft_server_proyect/servers/testing'
LOGPATH='/var/www/html/MinecraftWrapper/minecraft_server_proyect/servers/testing/logs'
BACKUPPATH='/var/www/html/MinecraftWrapper/minecraft_server_proyect/backups/testing'
MAXHEAP=2048
MINHEAP=1024
